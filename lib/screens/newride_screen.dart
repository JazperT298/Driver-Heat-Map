...
import 'package:driver_heat_map/services/mapkit_services.dart';
import 'package:driver_heat_map/widgets/collect_fare_dialog.dart';
...
class _NewRideScreenState extends State<NewRideScreen> {
  ...
  Future<void> getPlaceDirection(LatLng pickUpLatLng, LatLng dropOffLatLng) async {
    ...
    var details = await AssistantServices.obtainPlaceDirectionDetails(pickUpLatLng, dropOffLatLng);
  ...
  void updateRideDetails() async {
    if (isRequestingDirection == false) {
      ...
      var directionDetails = await AssistantServices.obtainPlaceDirectionDetails(posLatLng, destinationLatLng);
  ...
  endTheTrip() async {
    ...
    var directionalDetails = await AssistantServices.obtainPlaceDirectionDetails(widget.rideDetails!.pickup!, currentLatLng);

    Navigator.pop(context);

    int fareAmount = AssistantServices.calculateFares(directionalDetails!);
